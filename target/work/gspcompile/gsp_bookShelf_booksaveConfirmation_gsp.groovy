...
class gsp_bookShelf_booksaveConfirmation_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/book/saveConfirmation.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',18,['action':("list")],2)
printHtmlPart(9)
})
...
public static final long LAST_MODIFIED = 1504932620790L
