...
class gsp_bookShelf__errors_500_gsp extends GroovyPage {
...
if(true && (exception)) {
printHtmlPart(23)
for( _it1473214828 in (exception.stackTraceLines) ) {
changeItVariable(_it1473214828)
...
public static final long LAST_MODIFIED = 1504022056004L
