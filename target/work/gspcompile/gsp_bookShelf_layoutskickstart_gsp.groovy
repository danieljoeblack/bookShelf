...
class gsp_bookShelf_layoutskickstart_gsp extends GroovyPage {
...
printHtmlPart(6)
expressionOut.print(resource(dir:'css',file:'bookMain.css'))
printHtmlPart(7)
...
public static final long LAST_MODIFIED = 1505073241351L
