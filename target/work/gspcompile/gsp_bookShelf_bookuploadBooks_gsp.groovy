...
class gsp_bookShelf_bookuploadBooks_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/book/uploadBooks.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(5)
invokeTag('actionSubmit','g',20,['id':("uploadButton"),'action':("upload"),'class':("btn btn-default"),'value':("Upload")],-1)
printHtmlPart(6)
})
...
public static final long LAST_MODIFIED = 1504931941537L
